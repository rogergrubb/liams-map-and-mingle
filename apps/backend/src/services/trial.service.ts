...
const PREMIUM_TIER_LIMITS = {
  pinsPerDay: 999999,
  pinsPerMonth: 999999,
  minglesPerDay: 999999,
  minglesPerMonth: 999999,
...
export class TrialService {
   ...
   */
  static getFeatureLimits(subscriptionStatus: string | null, subscriptionTier: string | null = null) {
    // Premium users have unlimited access
    if (subscriptionStatus === 'active' && subscriptionTier === 'premium') {
      return PREMIUM_TIER_LIMITS;
    }
    // Basic subscribers
    if (subscriptionStatus === 'active' && subscriptionTier === 'basic') {
      return BASIC_TIER_LIMITS;
    }
    // Trial users get premium-like limits
  ...
  static async canPerformAction(
    ...
    const limits = TrialService.getFeatureLimits(subscriptionStatus, subscriptionTier);
